                                ...
                                <div aria-hidden="true" class="navdrawer navdrawer-permanent navdrawer-permanent-clipped mt-3" id="navdrawerPermanentClipped" tabindex="-1">
                                        <div class="navdrawer-content">
                                                <nav class="navdrawer-nav">
                                                        ...
                                                        <a class="nav-item nav-link" id="admin_side_Anc_course" href="<?php echo base_url('admin/announce'); ?>">
                                                                <span style="font-size: 1.5em;">
                                                        ...
                                                        <a class="nav-item nav-link" id="admin_side_Anc_services" href="<?php echo base_url('admin/announce'); ?>">
                                                                <span style="font-size: 1.5em;">
                                                        ...
                                                        <a class="nav-item nav-link" id="admin_side_Anc_personnel" href="<?php echo base_url('admin/announce'); ?>">
                                                                <span style="font-size: 1.5em;">
                                                        ...
                                                        <a class="nav-item nav-link" id="admin_side_Anc_about_us" href="<?php echo base_url('admin/announce'); ?>">
                                                                <span style="font-size: 1.5em;">
