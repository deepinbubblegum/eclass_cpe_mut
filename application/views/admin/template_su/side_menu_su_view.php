                                ...
                                <div aria-hidden="true" class="navdrawer navdrawer-permanent navdrawer-permanent-clipped mt-3" id="navdrawerPermanentClipped" tabindex="-1">
                                        <div class="navdrawer-content">
                                                <nav class="navdrawer-nav">
                                                        ...
                                                        <a class="nav-item nav-link" id="admin_side_Anc" href="<?php echo base_url('admin/course'); ?>">
                                                                <span style="font-size: 1.5em;">
                                                        ...
                                                        <a class="nav-item nav-link" id="admin_side_Anc" href="<?php echo base_url('admin/services'); ?>">
                                                                <span style="font-size: 1.5em;">
                                                        ...
                                                        <a class="nav-item nav-link" id="admin_side_Anc" href="<?php echo base_url('admin/announce_personnel'); ?>">
                                                                <span style="font-size: 1.5em;">
                                                        ...
                                                        <a class="nav-item nav-link" id="admin_side_Anc" href="<?php echo base_url('admin/announce_about_us'); ?>">
                                                                <span style="font-size: 1.5em;">
