        ...
        <div class="navdrawer navdrawer-left-admin" id="navdrawer-left-admin" tabindex="-1" style="display: none;" aria-hidden="true">
                <div class="navdrawer-content">
                        ...
                        <nav class="navdrawer-nav">
                                ...
                                <a class="nav-item nav-link" id="admin_Anc_course" href="<?php echo base_url('admin/announce'); ?>">
                                        <span style="font-size: 1.5em;">
                                ...
                                <a class="nav-item nav-link" id="admin_Anc_services" href="<?php echo base_url('admin/announce'); ?>">
                                        <span style="font-size: 1.5em;">
                                ...
                                <a class="nav-item nav-link" id="admin_Anc_personnel" href="<?php echo base_url('admin/announce'); ?>">
                                        <span style="font-size: 1.5em;">
                                ...
                                <a class="nav-item nav-link" id="admin_Anc_about_us" href="<?php echo base_url('admin/announce'); ?>">
                                        <span style="font-size: 1.5em;">
