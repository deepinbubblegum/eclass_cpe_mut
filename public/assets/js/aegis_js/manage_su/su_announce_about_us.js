$(document).ready(function () {
    ...
    var element = document.getElementById("admin_side_Anc_about_us");
    element.classList.add("bg-danger");
    var element = document.getElementById("admin_Anc_about_us");
    element.classList.add("bg-danger");
    /******************************************************************** */
    ...
    $('#save').click(function (e) {
            ...
            $.ajax({
                    type: "POST",
                    url: "../Admin_announce_about_us/add_data_ctl",
    ...
    function showdata() {
            $.ajax({
                    type: "POST",
                    url: "../Admin_announce_about_us/announce_showdata_ctl",
                    dataType: "json",
                    success: function (response) {
                            getdate = response;
                            html = '';
    ...
    $('#del_anc').click(function (e) {
            ...
            $.ajax({
                    type: "POST",
                    url: "../Admin_announce_about_us/del_data_ctl",
                    data: "&del_anc=" + dataid,
                    dataType: "json",
                    success: function (response) {
                            if (response == true) {
    ...
    $('#anc_edit_btn').click(function (e) {
            ...
            $.ajax({
                    type: "post",
                    url: "../Admin_announce_about_us/edit_data_ctl",
