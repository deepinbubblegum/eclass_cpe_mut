$(document).ready(function () {
    ...
    var element = document.getElementById("admin_side_Anc_personnel");
    element.classList.add("bg-danger");
    var element = document.getElementById("admin_Anc_personnel");
    element.classList.add("bg-danger");
    /******************************************************************** */
    ...
    $('#save').click(function (e) {
            ...
            $.ajax({
                    type: "POST",
                    url: "../admin_announce_personnel/add_data_ctl",
    ...
    function showdata() {
            $.ajax({
                    type: "POST",
                    url: "../admin_announce_personnel/announce_showdata_ctl",
                    dataType: "json",
                    success: function (response) {
                            getdate = response;
                            html = '';
    ...
    $('#del_anc').click(function (e) {
            ...
            $.ajax({
                    type: "POST",
                    url: "../admin_announce_personnel/del_data_ctl",
                    data: "&del_anc=" + dataid,
                    dataType: "json",
                    success: function (response) {
                            if (response == true) {
    ...
    $('#anc_edit_btn').click(function (e) {
            ...
            $.ajax({
                    type: "post",
                    url: "../admin_announce_personnel/edit_data_ctl",
